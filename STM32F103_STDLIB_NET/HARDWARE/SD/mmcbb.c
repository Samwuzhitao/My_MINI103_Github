...
#define SD_CS_CLK      RCC->APB2ENR|=1<<4    //使能PORTD时钟
#define SD_CS_DIR_OUT	GPIOC->CRL&=0XFFFFF0FF; GPIOC->CRL|=0X00000300 //PE5 推挽输出 LED1 
...
{
	SPIx_Init();
	SPIx_SetSpeed(SPI_SPEED_256);	 //设置spi为低速模式
	SD_CS_CLK;
	SD_CS_DIR_OUT;
	SD_CS_H();
}
